...
var getValues = function(shape) {
  return getExtensionElements(getBusinessObject(shape), 'activiti:FormData')[0].fields[0].values;
};
    ...
    describe('add activiti:value', function() {
      ...
      describe('on the business object', function() {
        ...
        beforeEach(function() {
          ...
          getValues = function() {
            return getExtensionElements(getBusinessObject(startEvent_2), 'activiti:FormData')[0].fields[0].values;
          };
        });
