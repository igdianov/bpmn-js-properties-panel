...
describe('implementation type', function() {
    ...
    describe('from class', function() {
      ...
      describe('to expression', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should execute', function() {
            // then
            expect(bo.get('activiti:class')).to.be.undefined;
            expect(bo.get('activiti:expression')).not.to.be.undefined;
          });
          ...
          it('should undo', inject(function(commandStack) {
            ...
            // then
            expect(bo.get('activiti:class')).not.to.be.undefined;
            expect(bo.get('activiti:expression')).to.be.undefined;
          }));
      ...
      describe('to delegate expression', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should execute', function() {
            // then
            expect(bo.get('activiti:class')).to.be.undefined;
            expect(bo.get('activiti:delegateExpression')).not.to.be.undefined;
          });
          ...
          it('should undo', inject(function(commandStack) {
            ...
            // then
            expect(bo.get('activiti:class')).not.to.be.undefined;
            expect(bo.get('activiti:delegateExpression')).to.be.undefined;
          }));
      ...
      describe('to external', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should execute', function() {
            // then
            expect(bo.get('activiti:class')).to.be.undefined;
            expect(bo.get('activiti:type')).to.equal('external');
            expect(bo.get('activiti:topic')).not.to.be.undefined;
          });
          ...
          it('should undo', inject(function(commandStack) {
            ...
            // then
            expect(bo.get('activiti:class')).not.to.be.undefined;
            expect(bo.get('activiti:type')).to.be.undefined;
            expect(bo.get('activiti:topic')).to.be.undefined;
          }));
      ...
      describe('to dmn', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should execute', function() {
            // then
            expect(bo.get('activiti:class')).to.be.undefined;
            expect(bo.get('activiti:decisionRef')).not.to.be.undefined;
          });
          ...
          it('should undo', inject(function(commandStack) {
            ...
            // then
            expect(bo.get('activiti:class')).not.to.be.undefined;
            expect(bo.get('activiti:decisionRef')).to.be.undefined;
          }));
      ...
      describe('to class', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should undo', inject(function(commandStack) {
            ...
            // then
            expect(bo.get('activiti:class')).to.be.undefined;
            expect(bo.get('activiti:type')).not.to.be.undefined;
            expect(bo.get('activiti:topic')).not.to.be.undefined;
          }));
  ...
  describe('other extension elements', function() {
    ...
    it('should retain other extension elements when removing connector', inject(function(elementRegistry, selection) {
      ...
      var listeners = extensionElementsHelper.getExtensionElements(bo, 'activiti:ExecutionListener');
