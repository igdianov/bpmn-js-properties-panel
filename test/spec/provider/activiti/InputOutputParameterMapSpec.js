...
function getParameters(bo, prop) {
  return getElements(bo, 'activiti:InputOutput', prop);
}
    ...
    describe('to text', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should undo', inject(function(commandStack) {
          ...
          // then
          expect(parameter.value).to.be.undefined;
          expect(is(parameter.definition, 'activiti:Map')).to.be.true;
        }));
    ...
    describe('to script', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          ...
          // then
          expect(parameter.value).to.be.undefined;
          expect(is(parameter.definition, 'activiti:Script')).to.be.true;
        });
    ...
    describe('to list', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          ...
          // then
          expect(parameter.value).to.be.undefined;
          expect(is(parameter.definition, 'activiti:List')).to.be.true;
        });
