...
describe('decision-business-rule-task-properties', function() {
  ...
  it('should fetch properties of decision business rule task', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(decisionRefField.value).to.equal(businessObject.get('activiti:decisionRef'));
    expect(resultVariable.value).to.equal('resVar');
    expect(resultVariable.value).to.equal(businessObject.get('activiti:resultVariable'));
  }));
  ...
  it('should fill decisionRef field for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject).not.to.have.property('activiti:decisionRef');
  ...
  it('remove decisionRef field is not necessary for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    // given
    expect(businessObject.get('activiti:decisionRef')).to.equal('Bar');
    ...
    expect(businessObject.get('activiti:decisionRef')).to.equal('');
  }));
  ...
  it('should exist default value "latest" for decision ref binding for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    // given
    expect(implType.value).to.equal('');
    expect(businessObject).not.to.have.property('activiti:decisionRefBinding');
  ...
  it('should change decision ref binding to version for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:decisionRefBinding')).to.equal(decisionRefBinding.value);
    expect(businessObject).not.to.have.property('activiti:decisionRefVersion');
    ...
    expect(businessObject.get('activiti:decisionRefVersion')).to.equal(decisionRefVersion.value);
  }));
  ...
  it('should change decision ref binding to versionTag for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:decisionRefVersionTag')).to.equal(decisionRefVersionTag.value);
  }));
  ...
  it('remove decision ref version is not necessary for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:decisionRef')).to.equal(decisionRefValue.value);
    ...
    expect(businessObject.get('activiti:decisionRefVersion')).to.be.undefined;
  }));
  ...
  it('should change implementation type from DMN to Java Class for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject).not.to.have.property('activiti:decisionRefBinding');
    expect(businessObject).not.to.have.property('activiti:decisionRefVersion');
    expect(businessObject.get('activiti:class')).to.be.exist;
    expect(delegateField.value).to.equal('foo');
    expect(businessObject.get('activiti:class')).to.equal(delegateField.value);
    expect(businessObject).not.to.have.property('activiti:mapDecisionResult');
  ...
  it('should remove result variable value for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject).not.to.have.property('activiti:resultVariable');
  }));
  ...
  it('should remove decision ref value field for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(implType.value).to.equal('dmn');
    expect(decisionRefField.value).to.equal('Bar');
    expect(businessObject.get('activiti:decisionRef')).to.equal(decisionRefField.value);
  ...
  it('should remove decision ref version value field for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:decisionRef')).to.equal(decisionRefField.value);
    expect(businessObject.get('activiti:decisionRefBinding')).to.equal(decisionRefBinding.value);
    expect(businessObject.get('activiti:decisionRefVersion')).to.equal(decisionRefVersionField.value);
  ...
  it('should set map decision result with default value "resultList" when fill result variable', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:mapDecisionResult')).to.equal(mapDecisionResult.value);
    expect(businessObject.get('activiti:resultVariable')).to.equal(dmnResultVariableInput.value);
  }));
  ...
  it('should set map decision result to default value when removing result variable', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(mapDecisionResult.className).to.contain('bpp-hidden');
    expect(dmnResultVariableInput.value).to.be.empty;
    expect(businessObject.get('activiti:mapDecisionResult')).to.equal('resultList');
    expect(businessObject.get('activiti:resultVariable')).to.be.undefined;
  }));
  ...
  it('should hidden map decision result select box when change implementation type from DMN to Expression for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:decisionRef')).to.equal(decisionRefValue.value);
    expect(businessObject.get('activiti:decisionRefBinding')).to.equal(decisionRefBinding.value);
    expect(businessObject.get('activiti:resultVariable')).to.equal(dmnResultVariable.value);
    expect(businessObject.get('activiti:mapDecisionResult')).to.equal(mapDecisionResult.value);
    expect(delegateField.value).to.be.empty;
    expect(businessObject).not.to.have.property('activiti:expression');
  ...
  it('should fetch decisionRefTenantId for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(inputField.value).to.equal(businessObject.get('activiti:decisionRefTenantId'));
  }));
  ...
  it('should remove decisionRefTenantId field for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:decisionRefTenantId')).to.be.undefined;
  }));
