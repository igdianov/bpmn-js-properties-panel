...
describe('callActivity - properties', function() {
  ...
  function getCamundaInWithBusinessKey(extensionElements) {
    ...
    if (extensionElements && extensionElements.values) {
      forEach(extensionElements.values, function(value) {
        if (is(value, 'activiti:In') && value.businessKey) {
  ...
  describe('get', function() {
    ...
    it('#calledElementBinding', inject(function(propertiesPanel, selection, elementRegistry) {
      ...
      expect(selectedOption.value).to.equal(bo.get('activiti:calledElementBinding'));
    ...
    it('#calledElementTenantId', inject(function(propertiesPanel, selection, elementRegistry) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:calledElementTenantId'));
    ...
    it('#caseTenantId', inject(function(propertiesPanel, selection, elementRegistry) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:caseTenantId'));
    ...
    it('#caseRef', inject(function(propertiesPanel, selection, elementRegistry) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:caseRef'));
    ...
    it('#caseBinding', inject(function(propertiesPanel, selection, elementRegistry) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:caseBinding'));
    ...
    it('#caseVersion', inject(function(propertiesPanel, selection, elementRegistry) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:caseVersion'));
    ...
    it('#variableMappingClass', inject(function(propertiesPanel, elementRegistry, selection) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:variableMappingClass'));
    ...
    it('#variableMappingDelegateExpression', inject(function(propertiesPanel, elementRegistry, selection) {
      ...
      expect(field.value).to.equal(businessObject.get('activiti:variableMappingDelegateExpression'));
  ...
  describe('set', function() {
    ...
    describe('#calledElementBinding', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:calledElementBinding')).to.equal('latest');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:calledElementBinding')).to.equal('version');
        }));
    ...
    describe('#calledElementVersion', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:calledElementVersion')).to.equal('42');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:calledElementVersion')).to.equal('17');
        }));
    ...
    describe('#calledElementVersionTag', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:calledElementVersionTag')).to.equal('bar');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:calledElementVersionTag')).to.equal('foo');
        }));
    ...
    describe('#caseRef', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:caseRef')).to.equal('myCase');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:caseRef')).to.equal('checkCreditCase');
        }));
    ...
    describe('#caseVersion', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:caseVersion')).to.equal('24');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:caseVersion')).to.equal('17');
        }));
    ...
    describe('#calledElementTenantId', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:calledElementTenantId')).to.equal('tenant2');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:calledElementTenantId')).to.equal('tenant1');
        }));
    ...
    describe('#caseTenantId', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:caseTenantId')).to.equal('tenant2');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:caseTenantId')).to.equal('tenant1');
        }));
    ...
    describe('#variableMappingClass', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:variableMappingClass')).to.equal('FOO');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:variableMappingClass')).to.equal('test');
        }));
    ...
    describe('#variableMappingDelegateExpression', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:variableMappingDelegateExpression')).to.equal('FOO');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:variableMappingDelegateExpression')).to.equal('${test}');
        }));
      ...
      describe('change to #CMMN', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should execute', function() {
            ...
            expect(bo.get('activiti:calledElementVersion')).to.be.undefined;
            expect(bo.get('activiti:calledElementTenantId')).to.be.undefined;
            expect(bo.get('activiti:variableMappingClass')).to.be.undefined;
            expect(bo.get('activiti:variableMappingDelegateExpression')).to.be.undefined;
            expect(bo.get('activiti:caseRef')).to.exist;
          ...
          it('should undo', inject(function(commandStack) {
            ...
            expect(bo.get('activiti:caseRef')).to.be.undefined;
      ...
      describe('change to #variableMappingDelegateExpression', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should execute', function() {
            ...
            expect(bo.get('activiti:variableMappingClass')).to.be.undefined;
            expect(bo.get('activiti:variableMappingDelegateExpression')).to.exist;
          ...
          it('should undo', inject(function(commandStack) {
            ...
            expect(bo.get('activiti:variableMappingClass')).to.exist;
            expect(bo.get('activiti:variableMappingDelegateExpression')).to.be.undefined;
  ...
  describe('remove', function() {
    ...
    describe('#calledElementVersion', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:calledElementVersion')).to.eql('17');
        }));
    ...
    describe('#caseVersion', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(bo.get('activiti:caseVersion')).to.be.undefined;
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          expect(bo.get('activiti:caseVersion')).to.eql('17');
        }));
    ...
    describe('#caseTenantId', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          ...
          expect(bo.get('activiti:caseTenantId')).to.be.undefined;
  ...
  describe('default values', function() {
    ...
    it('#calledElementBinding', function() {
      ...
      expect(field.value).to.equal(bo.get('activiti:calledElementBinding'));
    ...
    it('#caseBinding', function() {
      ...
      expect(field.value).to.equal(bo.get('activiti:caseBinding'));
  ...
  it('should not show version field when changing callActivityType from BPMN to CMMN and back for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:calledElementBinding')).to.equal('latest'); // default value in camunda-moddle

    expect(businessObject.get('activiti:caseRef')).not.to.exist;
    expect(businessObject.get('activiti:caseBinding')).to.equal('latest');
    expect(businessObject.get('activiti:caseVersion')).not.to.exist;
    ...
    // property 'activiti:calledElementBinding' should not exist in the business object,
    // because there is the default value 'latest'
    expect(businessObject.get('activiti:calledElementBinding')).to.equal('latest');
    expect(businessObject.get('activiti:calledElementVersion')).not.to.exist;
  ...
  it('should not show version field when changing callActivityType from CMMN to BPMN and back for an element', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(businessObject.get('activiti:calledElement')).not.to.exist;
    expect(businessObject.get('activiti:calledElementBinding')).to.equal('latest'); // default value in the camunda-moddle
    expect(businessObject.get('activiti:calledElementVersion')).not.to.exist;
    ...
    expect(businessObject.get('activiti:caseRef')).to.be.empty;
    expect(businessObject.get('activiti:caseBinding')).to.equal('latest');
    expect(businessObject.get('activiti:caseVersion')).not.to.exist;
