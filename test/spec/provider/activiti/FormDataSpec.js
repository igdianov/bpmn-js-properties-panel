...
var activitiModdlePackage = require('activiti-bpmn-moddle/resources/activiti');
...
describe('form-data', function() {
  ...
  describe('form fields', function() {
    ...
    describe('activiti:validation', function() {
      ...
      describe('add constraint', function() {
        ...
        describe('on the business Object', function() {
          ...
          it('should execute', function() {
            ...
            expect(is(lastConstraint, 'activiti:Constraint')).to.be.true;
      ...
      describe('remove all constraints', function() {
        ...
        describe('on the business object', function() {
          ...
          it('should remove activiti:validation', function() {

            // then
            var formData = getExtensionElements(getBusinessObject(shape), 'activiti:FormData'),
          ...
          it('should remove activiti:validation - undo', inject(function(commandStack) {
          ...
          it('should remove activiti:validation - redo', inject(function(commandStack) {
    ...
    describe('integration', function() {
      ...
      it('should add constraint on bo without existing extension elements', inject(function(elementRegistry, selection) {
        ...
        // then
        expect(is(formField.validation, 'activiti:Validation')).to.be.true;

        var constraints = formField.validation.constraints;

        expect(constraints).to.have.length(1);
        expect(is(constraints[0], 'activiti:Constraint'));
