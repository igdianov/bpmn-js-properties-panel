...
describe('taskListeners-properties', function() {
  ...
  var CAMUNDA_TASK_LISTENER_ELEMENT = 'activiti:TaskListener',
      CAMUNDA_EXECUTION_LISTENER_ELEMENT = 'activiti:ExecutionListener';
  ...
  it('should fetch task listener properties for an user task', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(is(extensionElementsValues[1], 'activiti:TaskListener')).to.be.true;
  ...
  it('should not fetch task listener properties for a sequence flow', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    expect(is(bo.extensionElements.values[0], 'activiti:ExecutionListener')).to.be.true;
    expect(is(bo.extensionElements.values[0], 'activiti:TaskListener')).to.be.false;
