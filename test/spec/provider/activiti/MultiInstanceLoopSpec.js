...
describe('multiInstance-loop-properties', function() {
  ...
  describe('property controls', function() {
    ...
    it('should fetch the collection', function() {
      // then
      var collection = loopCharacteristics.get('activiti:collection');
    ...
    it('should fetch the element variable', function() {
      // then
      var elementVariable = loopCharacteristics.get('activiti:elementVariable');
  ...
  describe('collection', function() {
    ...
    describe('change collection', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(loopCharacteristics.get('activiti:collection')).to.equal('999');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          // then
          expect(loopCharacteristics.get('activiti:collection')).to.equal('foo');
        }));
    ...
    describe('add collection', function() {
      ...
      beforeEach(inject(function(propertiesPanel, selection, elementRegistry) {
        ...
        // assume
        expect(loopCharacteristics.get('activiti:collection')).not.to.be.ok;
  ...
  describe('element variable', function() {
    ...
    describe('change collection', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          expect(loopCharacteristics.get('activiti:elementVariable')).to.equal('999');
        });
        ...
        it('should undo', inject(function(commandStack) {
          ...
          // then
          expect(loopCharacteristics.get('activiti:elementVariable')).to.equal('bar');
        }));
    ...
    describe('add element variable', function() {
      ...
      beforeEach(inject(function(propertiesPanel, selection, elementRegistry) {
        ...
        // assume
        expect(loopCharacteristics.get('activiti:elementVariable')).not.to.be.ok;
