...
describe('listener-fieldInjection-properties', function() {
  ...
  var EXECUTION_LISTENER_TYPE = 'activiti:ExecutionListener',
      TASK_LISTENER_TYPE = 'activiti:TaskListener';
  ...
  describe('add activiti:field', function() {
  ...
  describe('remove activiti:field', function() {
  ...
  describe('remove activiti:listener', function() {
