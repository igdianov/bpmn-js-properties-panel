...
var getProperties = function(shape) {
  var properties = getExtensionElements(getBusinessObject(shape), 'activiti:FormData')[0].fields[0].properties;
    ...
    describe('add activiti:property', function() {
      ...
      describe('on the business object', function() {
        ...
        it('should execute', function() {
          ...
          expect(bo.get('activiti:formKey')).to.equal('myForm.html');
        });
