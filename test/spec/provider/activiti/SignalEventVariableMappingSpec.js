...
describe('SignalEvent - variable mapping', function() {
  ...
  describe('IntermediateThrowEvent', function() {
    ...
    it('should fetch activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should remove activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
      var shape = elementRegistry.get('IntermediateThrowEvent_1');
      selection.select(shape);
    ...
    describe('should add activiti:in mapping to a signal intermediate throw event', function() {
    ...
    it('should fetch invalid source field of a activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should change source field of a activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should mark source field of a activiti:in mapping of a signal intermediate throw event as invalid', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should change sourceExpression field of a activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should fetch the variables attr of a activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should remove the variables attr of a activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
    ...
    it('should set the variables attr of a activiti:in mapping of a signal intermediate throw event', inject(function(propertiesPanel, selection, elementRegistry) {
  ...
  describe('EndEvent', function() {
    ...
    it('should fetch activiti:in mapping of a signal end event', inject(function(propertiesPanel, selection, elementRegistry) {
